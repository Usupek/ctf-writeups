...
However, **some writeups are still only available as PDF files**. These:

- Have **not yet been converted to Markdown**, and  
- Therefore **will not appear in GitBook** until the migration is complete.
...
This repository is mainly a personal learning log, but:

- If you notice mistakes or have improvements, feel free to open an issue or pull request.
- Alternative solutions, cleaner exploits, or better explanations are always welcome.
